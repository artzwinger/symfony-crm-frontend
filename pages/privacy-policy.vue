  ...
  <div>
    ...
    <div class="container">
      <div class="content-container shadow-lg bg-white rounded p-5">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or &quot;Our&quot; in this Agreement) refers to OCHSIGNUP LLC, 1 Cupertino, CA 95014.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Online class help sign up, accessible from <a
              href="https://ochsignup.com/" rel="external nofollow noopener" target="_blank">https://ochsignup.com/</a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By visiting this page on our website: <nuxt-link to="contact"
                                                       rel="external nofollow noopener" target="_blank">https://www.ochsignup.com/contact</nuxt-link>
          </li>
        </ul>
      </div>
    </div>
